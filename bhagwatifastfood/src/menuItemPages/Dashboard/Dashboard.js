                    ...
                    <div className='h-full grid grid-cols-12'>
                        <div className={`h-full ${editPriceMode ? 'col-span-9' : 'col-span-10'}`}>
                            <div className='relative h-full'>
                                ...
                                <div className={`flex ml-12 gap-3 menuCategoryScroll overflow-x-auto h-full ${editPriceMode ? 'cursor-not-allowed' : ''}`} style={{ whiteSpace: 'nowrap' }} ref={scrollContainerRef}>
                                                ...
                                                >
                                                    ...
                                                    <TableCell align='right'>
                                                        <div className="flex w-100 justify-end">
                                                            {menuId === 'base_2001' && (
                                                                <>
                                                                    <div onClick={() => { handleEditItem(item); setPrice(item?.variantsList[0]?.price); }} className='rounded-lg bg-gray-100 p-2 ml-4 cursor-pointer table_Actions_icon2 hover:bg-blue-600'>
                    ...
                    <div className="grid grid-cols-12 gap-4">
                        ...
                        <div className="col-span-2">
                            <TextField
                                ...
                                label="Price"
                                variant="outlined"
                                value={editData ? editData?.variantsList[0]?.price ? editData?.variantsList[0]?.price : '' : price || ''}
                                onChange={(e) => {
                        ...
                        <div className="col-span-2">
                            <FormControl fullWidth>
                                <InputLabel id="demo-simple-select-label">Spicy Level</InputLabel>
                                <Select
                                    labelId="demo-simple-select-label"
                                    id="demo-simple-select"
                                    label="Spicy Level"
                                    ...
                                    <div className="">
                                        <div className="flex gap-4">
                                            ...
                                            {variantMode.isEdit && variant.unit !== 'NO' && (
                                                <div className='rounded-lg bg-gray-100 p-2 ml-4 cursor-pointer table_Actions_icon2 hover:bg-red-600' onClick={() => handleDeleteVariant(index, variant.unit)}>
                                                    <DeleteOutlineOutlinedIcon className='text-gray-600 table_icon2' />
                                                </div>
                                            )}
                                            {variantMode.isEdit && variant.unit === 'NO' && (
                                                <div className='rounded-lg bg-gray-300 p-2 ml-4 cursor-not-allowed' title="Delete disabled for 'NO' unit">
